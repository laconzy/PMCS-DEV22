...
public function preparation() {
    ...
    public function scan_barcode() {
        ...
        $previous_operation = $this->input->post('previous_operation');
        ...
        if ($operation == 1) {//this is first operation and bundle get from cutting
            ...
            if ($bundle == null && $bundle == false) {
                ...
                if ($is_exists) {
                    ...
                    $this->production_model->add_item_to_production($bundle, $operation, 'OUT', $line_no, $scan_date,$shift_no,0);
...
//print_r($bundle);
            ...
            if ($bundle == null || $bundle == false) {
                ...
                if ($is_exists) {
                    ...
                    $this->production_model->add_manual_item_to_production($bundle, $operation, 'OUT', $line_no, $scan_date,$shift_no,$location,$site, $hour);
    ...
    public function destroy_list() {
        ...
        if($next_operation_productions != null && sizeof($next_operation_productions) > 0){
          ...
          for ($x = 0; $x < sizeof($barcodes2); $x++) {
              ...
              $this->production_model->destroy($operation_id, $barcodes2[$x]);
          }
          echo json_encode([
              'status' => 'success',
