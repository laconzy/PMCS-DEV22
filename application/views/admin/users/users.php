...
<html>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= base_url() ?>index.php/user/new_user" target="_blank">New user</a></li>
                        <li class="divider"></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body">
                  ...
                  <table id="users-table" class="display nowrap cell-border compact" cellspacing="0" width="100%">
                	<thead>
                    <tr>
                        <th>ID</th>
                        <th>First name</th>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/admin/users/user_list.js"></script>
