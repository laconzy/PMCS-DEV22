...
<html>
  <head>
    ...
    <title>PMCS | Supplier AOD List</title>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= base_url() ?>index.php/aod" target="_blank">New Supplier AOD</a></li>
                        <li class="divider"></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<table id="aod-table" class="display nowrap cell-border compact" cellspacing="0" width="100%">
								<thead>
								<tr>
									<th>AOD No</th>
									<th>Order Id</th>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/aod/aod_list.js"></script>
