...
foreach ($bundle_chart as $row) { ?>
	...
	if($s==1){
		$s=$row['size_code'];
		$d=$row['diff'];
	}else if($s!=$row['size_code'] || $d!=$row['diff']){
		$i++;
		$s=$row['size_code'];
		$d=$row['diff'];
	}
...
if($loop==0){
	...
	continue;
		...
		<div style="width:5cm;height:4cm;border: solid 1px;font-family:Verdana, Geneva, sans-serif;font-size:12px;float:left;margin-left:2px;margin-top:2px;"
			 align="center">
			...
			<table width="100%" border="0" style="margin-top:5px;">
				...
				<tr style="font-family:Verdana, Geneva, sans-serif;font-size:10px;">
					...
					<td colspan="10" style="font-weight:bold;background-color:#FFF;color:#000"
						align="center"><?php echo $value."(".$row['start']."-".$row['end'].")"; ?><br></td>
				</tr>
				<tr style="font-family:Verdana, Geneva, sans-serif;font-size:10px;">
				...
				<tr style="font-family:Verdana, Geneva, sans-serif;font-size:7px;color:#000">

					<td><label>&nbsp;&nbsp;Laysheet#</label></td>

					<td>:</td>

					<td><strong><?= $laysheet['laysheet_no'] ?></strong></td>
...
<!--					<td><strong>--><?//= $row['size_code']."(".chr($i) . PHP_EOL.")"; ?><!--</strong></td>-->
					<td><strong><?= $row['size_code']."(".chr($row['letter']).PHP_EOL.")"; ?></strong></td>
