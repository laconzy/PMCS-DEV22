					...
					<div class="panel-body" id="data-form">
						...
						<div class="row form-group">
							...
							<div class="col-md-3">
								...
								<input type="number" class="form-control input-sm" placeholder="Enter plies count"
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<button class="btn btn-info" id="btn_print">Print Bundle Chart <i id="btn-save-i"></i>
								</button>

								<button class="btn btn-info" id="btn_print_barcode">Print Barcode <i
											id="btn-save-i"></i></button>
...
<script src="<?php echo base_url(); ?>assets/views/cutting/bundle_creation.js?v1.2"></script>
