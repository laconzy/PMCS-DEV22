...
<head>
	...
	<title>PMCS | Mini Bundle Chart</title>
		...
		<div class="hpanel">
			...
			<div class="panel-body">
				...
				<h2 class="font-light m-b-xs text-success">
					...
					<?= isset($site) ? 'Mini Bundle Chart' : 'Mini Bundle Chart'; ?>
			...
			<div class="col-lg-12">
				...
				<div class="hpanel">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-group input-daterange" id="ooo">
						...
						<hr>
						<div class="row form-group" id="complete_div">
								<div class="col-md-3">
                    ...
                    <!-- <div class="input-group">
                        ...
                        <div class="input-group input-daterange">
                            <input type="text" class="form-control input-sm date" value="<?= date('Y-m-d'); ?>" id="complete_date" >
                        </div>
                    </div> -->

										<div class='input-group date' id='complete_date_div'>
				               <input type='text' class="form-control input-sm" id="complete_date" value="<?= date('Y-m-d'); ?>" disabled/>
				               ...
				               <span class="glyphicon glyphicon-time"></span>
								...
								<div class="col-md-3">
	                    <label >Cutter - Superviser Name</label>
	                    <input type="text" class="form-control input-sm" value="" id="superviser" disabled>
	             </div>
							<div class="col-md-1" id="btn_complete_div" style="display:none">
										<button class="btn btn-primary btn-sm" id="btn_complete" style="margin-top:22px;">Complete</button>
							</div>
							<div class="col-md-1" id="btn_incomplete_div" style="display:none">
										<button class="btn btn-primary btn-sm" id="btn_incomplete" style="margin-top:22px">Incomplete</button>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-2">
								<button class="btn btn-primary" id="btn_create_bundles" style="display:none">Create Bundles <i id="btn-save-i"></i></button>
							</div>
						</div>
						<hr>
...
<script src="<?php echo base_url(); ?>assets/views/cutting/bundle_creation_2.js?v1.4"></script>
