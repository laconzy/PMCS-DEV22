...
<html>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?= base_url() ?>index.php/cut_plan" target="_blank">New Cut plan</a></li>
                ...
                <div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<table id="cut-plans-table" class="display nowrap cell-border compact" cellspacing="0" width="100%">
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <script src="<?php echo base_url(); ?>assets/views/cutting/cut_plan_list.js"></script>
