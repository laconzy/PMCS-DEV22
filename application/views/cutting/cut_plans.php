                    ...
                    <div class="col-lg-12">
                        <div class="hpanel">
                            ...
                            <div class="panel-body">
                                ...
                                <table id="06-users-table" class="display nowrap cell-border compact" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Item ID</th>
                                            <th>Item Code</th>
...
//                                echo '<th>Delete</th>';
        ...
        <!-- page js file -->
        <script src="<?php echo base_url(); ?>assets/views/item/items.js"></script>
