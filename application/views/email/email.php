																...
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">
                                                                                                                                                    <?php if($header1 != null && $header1 != false) { echo $header1; } ?>
                                                                                                                                                </h1>
																		...
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                                                                                                    <?php if($header_text != null && $header_text != false){ echo $header_text;} ?> 
                                                                                                                                                </div>
																	</td>
																</tr>
															</table>
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																					...
																					<div mc:edit="body" style="width:500px;text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                                                                                                            ...
                                                                                                                                                                            <?php if($content1 != null && $content1 != false){ echo $content1;}?>
																...
																<tr>
																	<td align="left" valign="top" class="textContent" style="width:500px">
																		<div style="width:500px;text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">
                                                                                                                                                    <?php if($content2 != null && $content2 !=  false){echo $content2;}?>
                                                                                                                                                </div>
																	</td>
																</tr>
															</table>
