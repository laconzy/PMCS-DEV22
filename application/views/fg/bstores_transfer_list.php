...
<html>
  <head>
    ...
    <title>PMCS | B Stores Transfer List</title>
            ...
            <div class="panel-body">
                ...
                <div id="hbreadcrumb" class="pull-right m-t-lg">
                    <ol class="hbreadcrumb breadcrumb">
                        ...
                        <li class="active">
                            <span>B Stores Transfer List</span>
                        </li>
                    </ol>
                </div>
                <h2 class="font-light m-b-xs text-success">
                    B STORES TRANSFER LIST
                </h2>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="bstores_transfer/new_transfer" target="_blank">New B Stores Transfer</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/fg/bstores_transfered_list.js"></script>
