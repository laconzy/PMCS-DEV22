				...
				<div class="hpanel">
					...
					<div class="panel-body" id="data-form">
						...
						<div class="row" style="margin-top:20px">
							...
							<div class="container col-md-12 tableFixHead" >

								<h4>Order Details</h4>

								<table id="summery_table" class="table table-striped table-bordered table-hover col-md-12" width="100%">
						...
						<div class="row">
							...
							<div class="col-md-2">
								...
								<button class="btn btn-primary" id="print_report">

									Print <i id="btn-save-i"></i></button>
...
<script src="<?php echo base_url(); ?>assets/views/fg/fg_packing_list.js"></script>
