...
<html>
  <head>
    ...
    <title>PMCS | FG Transfer List</title>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="fg_transfer/new_transfer" target="_blank">New FG Transfer</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/fg/fg_transfered_list.js"></script>
