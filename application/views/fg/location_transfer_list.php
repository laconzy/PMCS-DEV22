...
<html>
  <head>
    ...
    <title>PMCS | Location Transfer List</title>
            ...
            <div class="panel-body">
                ...
                <div id="hbreadcrumb" class="pull-right m-t-lg">
                    <ol class="hbreadcrumb breadcrumb">
                        ...
                        <li class="active">
                            <span>Location Transfer List</span>
                        </li>
                    </ol>
                </div>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="location_transfer/new_transfer" target="_blank">New Location Transfer</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/fg/location_transfered_list.js?v1.1"></script>
