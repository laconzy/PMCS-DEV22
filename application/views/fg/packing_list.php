...
<head>
	...
	<title>PMCS | FG Packing List</title>
		...
		<div class="hpanel">
			...
			<div class="panel-body">
				...
				<h2 class="font-light m-b-xs text-success">
					...
					<?= isset($site) ? 'FG PACKING LIST' : 'FG PACKING LIST'; ?>
			...
			<div class="col-lg-12">
				<div class="hpanel">
					<div class="panel-body" id="data-form">
						<input type="hidden" value="<?= isset($packing_list_id) ? $packing_list_id : ''; ?>" id="packing_list_id">
						...
						<div class="row form-group">
							...
							<!-- <div class="col-md-1">
								<button class="btn btn-primary btn-sm" style="margin:20px;margin-left:-15px" id="btn_laysheet_search">Search</button>
							</div> -->

							<div class="col-md-2">
								<label>Packing List #</label>
								<input type="text" class="form-control input-sm" id="pack" disabled>
							</div>
							<div class="col-md-2">
								<label>PO#</label>
						...
						<div class="row form-group">
							<div class="col-md-2">
								...
								<input type="text" class="form-control input-sm" id="container" >
							</div>
							<div class="col-md-2">
								<label>Ref</label>
								<input type="text" class="form-control input-sm" id="ref_1" >
							</div>
							<div class="col-md-2">
								<label>Ref 2</label>
								<input type="text" class="form-control input-sm" id="ref_2" >
							</div>
							<div class="col-md-2">
								<label>Ref 3</label>
								<input type="text" class="form-control input-sm" placeholder="Enter plies count" id="ref_3" value="">
							</div>
							<div class="col-md-3">
								<label>Site</label>
						...
						<div class="row">
							<div class="col-md-6">
									<button class="btn btn-info btn-sm" id="btn_confirm" style="display:none">Confirm Packing List <i id="btn-confirm-i"></i></button>
									<button class="btn btn-primary btn-sm" id="print_report" style="display:none">Print <i id="btn-save-i"></i></button>
									<!-- <button class="btn btn-danger btn-sm" id="btn_unconfirm" >Unconfirm <i id="btn-save-i"></i></button> -->
							</div>
						</div>
					</div>
				</div>
...
<!-- page js file -->
<script src="<?php echo base_url(); ?>assets/views/fg/packing_list.js?v1.3"></script>
