		...
		<div style="width:100%">
			...
			<table style="width:100%;font-family: Verdana, Geneva, sans-serif;font-size: 10px;">
				...
				<tr>
					...
					<td style="width:30%"><b>:<?php echo $header_data['customer_po']; ?></b></td>
...
//echo $data[0]['order_id'];
	//$ord_qty=$this->packing_list_model->get_ord_qty($data[0]['order_id']);
					?>
					<td style="width:30%"><b></b></td>
				...
				<tr>
					...
					<td style="width:30%"><b>:<?= $total_orders_qty ?></b></td>
					<td style="width:30%"><b>Ship QTY #</b></td>
					<td style="width:30%"><b>:<?= $total_ship_qty ?></b></td>
			...
			<table style="font-size:9px" id="gpp-items">
				<thead>
					<tr>
						<td>FROM</td>
						<td>TO</td>
					  ...
					  <?php	}	?>
						...
						<td>Total PCS.</td>
						<td>Total CTN.</td>
						<td style="text-align:center">Total N.N.W</td>
						<td>N.W.</td>
						<td>G.W.</td>
						<td>CBM</td>
						<td>Mesurement</td>
