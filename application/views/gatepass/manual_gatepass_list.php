...
<html>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?= base_url() ?>index.php/gatepass/manual_gatepass" target="_blank">New Manual Gate Pass</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/gatepass/manual_gatepass_list.js"></script>
