...
<div class="container">
	...
	<div class="row">
		...
		<table style="width:100%">
			<tr>
				...
				<td style="width:20%;text-align:left;">
					<h4 style="font-weight:bold">DTRT Apparel</h4>
					<h5 style="font-weight:bold">www.dtrtapprel.com</h5>
				</td>
				<td width="30%"></td>
			</tr>
		</table>
		...
		<h4 style="font-weight:bold;text-align:center">Issue Note</h4>
				...
				<td class="td1" style="width:35%;vertical-align:top">
						<table id="tbl1">
							<tr>
								...
								<td>: <?= $header_data['packing_list_no'] ?></td>
							</tr>
							<!-- <tr>
								<td>Bom ID </td>
								<td>: <?= $header_data['bom_id'] ?></td>
							</tr> -->
							<!-- <tr>
								<td>PCD Date</td>
								<td>: <?= $header_data['pcd'] ?></td>
							</tr> -->
							<tr>
								<td>Packing Date</td>
								<td>: <?= $header_data['date'] ?></td>
							</tr>
							<!-- <tr>
								<td>Sub Contract PO</td>
								<td>: <?= $header_data['subcontract_po'] ?></td>
							</tr> -->
						</table>
					</td>

					<td class="td1" style="width:30%;vertical-align:top">
						<table id="tbl2">
							<tr>
								<td>Buyer Code</td>
								<td>: <?= $header_data['buyer_code'] ?></td>
							</tr>
							<tr>
								<td>Lot No</td>
								<td>: <?= $header_data['lot_no'] ?></td>
							</tr>
							<tr>
								<td>Adviced By</td>
								<td>: <?= $header_data['advicedby'] ?></td>
							</tr>
						</table>
					</td>
					...
					<td class="td1" style="width:35%">
						<table id="tbl3">
							<tr>
								<td>Buyer PO</td>
								<td>: <?= $header_data['buyer_po'] ?></td>
							</tr>
							<tr>
								<td>Style</td>
								<td>: <?= $header_data['style_no'] ?></td>
							</tr>
							<tr>
								<td>Attention</td>
								<td>: <?= $header_data['attention'] ?></td>
							</tr>
							<!-- <tr>
								<td>Managed By</td>
								<td>: <?= $header_data['packing_list_no'] ?></td>
			...
			<table style="width:100%;margin-top:5px;border : 1px solid #ddd;font-size : 11px;">
				<tr>
					<td style="width:15%;padding:3px">From</td>
					<td style="width:35%;padding:3px">: <?= $header_data['from_factory_name'] ?></td>
					<td style="width:15%;padding:3px">To</td>
					<td style="width:35%;padding:3px">: <?= $header_data['to_factory_name'] ?></td>
				</tr>
			</table>

			<h5 style="text-align:center;font-weight:bold;margin-top:15px;">Replacement Packing List</h5>


			<div class="">
			<table class="table table-striped table-bordered table-hover" width="100%">
					<thead style="font-size:11px" class="report-header">
							<tr>
									<th>No</th>
									<th>Item Code</th>
									<th>Color</th>
					...
					<tfoot>
						<tr>
							<td colspan="11" style="border-color:#FFF !important;">
		...
		<table style="width:100%">
			...
			<?php if(isset($packing_id)){
							...
							foreach ($roles as $row) {
								$x++;
								$issue_total += $row['issue']; ?>
			<table class="table table-striped table-bordered table-hover" style="width:240px;height:135px; border-style: solid;border-width: 5px; border-color:#413C3B">
			<!-- width:380px;height:288px; -->
					<tbody style="font-size:11px; border: none">
						

					<tr >
					<td style="border-style: none;text-align:right"></td>
							<td style="border-style: none;">FABRIC RELAX DETAILS</td>
							...
							<td style="border-style: none;">Order Code:</td>
							
							<td style="border-style: none;"><?= $header_data['order_code'] ?></td>
							...
							<td style="border-style: none;"><?= $header_data['date'] ?></td>
							...
							<td style="border-style: none;"><?= $row['pi_no'] ?></td>
							
							</tr>
							<tr>
					
							<td style="border-style: none;">Finish Time</td>
							...
							<td style="border-style: none;">Yard</td>
