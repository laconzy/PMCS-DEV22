...
<head>
	...
	<title>PMCS | Fabric Inspection</title>
...
<div>
	<h4 style="margin-bottom:20px;text-align:center;font-weight:bold">FABRIC INSPECTION</h4>
	...
	<div class="col-md-12" style="margin-bottom:20px">
		...
		<div class="col-md-3">
			<label>Role No(s)</label>
			<input class="form-control input-sm" autocomplete="off" id="role_no">
		</div>
		<div class="col-md-3">
	...
	<div class="col-md-12">
		...
		<div class="col-md-2">
			<label>Status</label>
			<select class="form-control input-sm" id="ins_status">
				<option value="">...Select One...</option>
		...
		<div class="col-md-2">
			<button class="btn btn-primary btn-sm" id="btn_status" style="margin-top:22px">Change Status <i id="btn_status_i"></i></button>
		</div>
		<div class="col-md-2">
			<label>Width</label>
			<input type="text" class="form-control input-sm" autocomplete="off" id="width">
		</div>
		<div class="col-md-2">
			<button class="btn btn-primary btn-sm" id="btn_width" style="margin-top:22px">Change Width <i id="btn_width_i"></i></button>
		</div>
		<div class="col-md-2">
			<label>Shade</label>
			<input type="text" class="form-control input-sm" autocomplete="off" id="shade">
		</div>
		<div class="col-md-2">
			<button class="btn btn-primary btn-sm" id="btn_shade" style="margin-top:22px">Change Shade <i id="btn_shade_i"></i></button>
		</div>
	</di>
...
<!-- page js file -->
<script src="<?php echo base_url(); ?>assets/views/inventory/fabric_inspection.js?v1.2"></script>
