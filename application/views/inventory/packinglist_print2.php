	...
	$(document).ready(function(){
		...
		let data = localStorage.getItem('pmcs_inv_data2');
		...
		for(let x = 0 ; x < data.length ; x++){
			str = `<div class="sticker" align="center">
				<table width="100%" border="0" style="margin-top:2px;">
					<tr>
						<td colspan="2" class="status" style="font-size:11px">FABRIC RELAX DETAILS</td>
					</tr>
					<tr>
						<td>Order Code</td>
					...
					<tr>
						<td class="part-no">Date</td>
						<td class="part-no">${data[x].pi_no}</td>
					</tr>
					<tr>
						<td class="part-no">Start Time</td>
						<td class="part-no">${data[x].pi_no}</td>
					</tr>
					<tr>
						<td class="part-no">Finish Time</td>
						<td class="part-no">${data[x].role_no} - QTY : ${data[x].actchchual}</td>
					</tr>
					<tr>
						<td class="part-no">Yard</td>
						<td class="part-no">${data[x].role_no}</td>
					</tr>
					<tr>
