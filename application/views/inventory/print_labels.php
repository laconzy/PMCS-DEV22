...
<div>
	<h4 style="margin-bottom:20px;text-align:center;font-weight:bold">PRINT LABELSss</h4>
	...
	<div class="col-md-12" style="margin-bottom:20px">
		...
		<div class="col-md-3">
			...
			<button class="btn btn-success btn-sm" id="btn_print" style="margin-top:22px">Print</button>
			<button class="btn btn-success btn-sm" id="btn_print2" style="margin-top:22px">Print 2</button>
		</div>
	</div>
...
<!-- page js file -->
<script src="<?php echo base_url(); ?>assets/views/inventory/print_labels.js?v1.1"></script>
