...
<html>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="barcode/barcode_new" target="_blank">New Barcode</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/master/barcode/barcode_list.js"></script>
