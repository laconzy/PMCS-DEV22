...
<html>
  <head>
    ...
    <title>PMCS | PCS Per Cartoon</title>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="cartoon_qty/cartoon_qty_new" target="_blank">New PCS Per Cartoon</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/master/cartoon_qty/cartoon_qty_list.js"></script>
