            ...
            <div class="panel-body">
                ...
                <div id="hbreadcrumb" class="pull-right m-t-lg">
                    <ol class="hbreadcrumb breadcrumb">
                        ...
                        <li class="active">
                            <span><?= isset($color) ? 'Update Colour' : 'New Colour'; ?></span>
                        </li>
                    </ol>
                </div>
                <h2 class="font-light m-b-xs text-success">
                    <?= isset($color) ? 'Update Colour' : 'New Colour'; ?>
                </h2>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo base_url(); ?>index.php/master/colour/colour_new" target="_self">New Colour</a></li>
                        <li class="divider"></li>
                    ...
                    <div class="panel-body" id="data-form">
                        ...
                        <div class="row">
                            <div class="col-md-4">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" placeholder="Enter colour Name"
                                        id="color-name" value="<?= isset($color) ? $color['color_name'] : '';?>">
                                </div>
                                <div class="form-group">
                                    <label>Active</label> <br>
                                    <?php $checked = (isset($color) && $color['active'] == 'Y') ? 'checked' : ''; ?>
                                    <input type="checkbox" id="color-active" <?= $checked; ?>>
                                </div>
                            </div>
						...
						<div class="row">
							<div class="col-md-2">
								...
								Save Colour Details <i id="btn-save-i"></i></button>
							</div>
						</div>
                    </div>
                </div>
