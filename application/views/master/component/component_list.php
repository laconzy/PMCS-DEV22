...
<html>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="component/component_new" target="_blank">New Component</a></li>
                        <li class="divider"></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<table id="component-table" class="display nowrap cell-border compact" cellspacing="0" width="100%">
								<thead>
								<tr>
									<th>ID</th>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/master/component/component_list.js"></script>
