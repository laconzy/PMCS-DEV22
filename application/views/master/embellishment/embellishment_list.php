...
<html>
  <head>
    ...
    <title>PMCS | Embellishment Types</title>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="embellishment/embellishment_new" target="_blank">New Embellishment Type</a></li>
                        <li class="divider"></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<table id="embellishment-table" class="display nowrap cell-border compact" cellspacing="0" width="100%">
								<thead>
								<tr>
									<th>ID</th>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/master/embellishment/embellishment_list.js"></script>
