...
<html>
  <head>
    ...
    <title>PMCS | HOD Allocations</title>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="hod_allocation/hod_allocation_new" target="_blank">New Allocation</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/master/hod_allocation/hod_allocation_list.js"></script>
