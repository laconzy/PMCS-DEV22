...
<html>
            ...
            <div class="panel-body">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="item/item_new" target="_blank">New Item</a></li>
                        <li class="divider"></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<table id="item-table" class="display nowrap cell-border compact" cellspacing="0" width="100%">
								<thead>
								<tr>
									<th>ID</th>
									<th>Item Code</th>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/master/item/item_list.js"></script>
