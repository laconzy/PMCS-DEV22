...
<html>
  <head>
    ...
    <title>PMCS | Barcode Transfer List</title>
            ...
            <div class="panel-body">
                ...
                <div id="hbreadcrumb" class="pull-right m-t-lg">
                    <ol class="hbreadcrumb breadcrumb">
                        ...
                        <li class="active">
                            <span>Barcode Transfer List</span>
                        </li>
                    </ol>
                </div>
                <h2 class="font-light m-b-xs text-success">
                    BARCODE TRANSFER LIST
                </h2>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo base_url(); ?>index.php/production/barcode_transfer/new_transfer" target="_blank">New Barcode Transfer</a></li>
                        <li class="divider"></li>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/production/barcode_transfer_list.js"></script>
