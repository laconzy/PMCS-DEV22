...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    <div class="panel-body" id="data-form">
                        ...
                        <?php if($operation_name == 'Cutting Out') { ?>
                          <div class="col-md-2">
                        ...
                        <?php }
                                ...
                                echo '<input type="hidden" id="shift_type" value="">';
                              }
                         ?>
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/production/production.js?v1.3"></script>
