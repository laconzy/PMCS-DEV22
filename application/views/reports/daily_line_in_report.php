...
<head>
	...
	<title>PMCS | Daily Production Report</title>
...
<body>
	...
	<div>
		...
		<div class="col-md-12" style="margin-bottom:20px">
			<div class="col-md-2">
				<button class="btn btn-success btn-sm" onclick="ExportToExcel('xlsx')">Export table to excel</button>
...
<script src="<?php echo base_url(); ?>assets/views/report/daily_production.js?v1.1"></script>
