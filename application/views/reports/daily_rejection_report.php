...
<head>
	...
	<title>PMCS | daily Rejection Report</title>
...
<div>
	<h4 style="margin-bottom:20px;text-align:center;font-weight:bold">DAILY REJECTION REPORT</h4>
	...
	<div class="col-md-12" style="margin-bottom:20px">
		<div class="col-md-3">
          ...
          <input type="text" class="form-control input-sm" autocomplete="off" placeholder="Select from date" id="from_date">
      </div>
		</div>
		<div class="col-md-3">
			<div class="input-group date">
					<label>To Date</label>
          <input type="text" class="form-control input-sm" autocomplete="off" placeholder="Select to date" id="to_date">
      </div>
		</div>
		<div class="col-md-1">
			<button class="btn btn-primary btn-sm" style="margin-top:20px" id="btn_search">Search <i id="btn_search_i"></i></button>
		</div>
		<div class="col-md-1">
			<button class="btn btn-success btn-sm" style="margin-top:20px" id="btn_export">Export table to excel</button>
		</div>
	</div>
...
<script src="<?php echo base_url(); ?>assets/views/report/daily_rejection_report.js?v1.2"></script>
