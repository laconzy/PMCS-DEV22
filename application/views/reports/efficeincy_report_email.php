...
<body>
	...
	<div class="row" style="margin-top:20px;">
		...
		<div class="col-md-12">
			<h3 style="margin-bottom:20px;text-align:center;font-weight:bold;color:#ea6153">DAILY EFFICIENCY REPORT : <?= $date ?></h3>
		</div>
					...
					<table class="<?= get_table_style_class($tbl_style_count); ?>" style="max-width:700px">
						<thead>
								<?php
									...
									echo '<tr><th colspan="'.$category_count.'" class="td-special">DAILY TOTAL (SHIFT A + SHIFT B)</th></tr>';
				...
				<table class="<?= get_table_style_class($tbl_style_count); ?>" style="max-width:700px">
					<thead>
							<?php
								...
								echo '<tr><th colspan="'.$category_count.'" class="td-special">SHIFT A</th></tr>';
								echo '<tr> <th class="td-special">CATEGORY</th>';
			...
			<table class="<?= get_table_style_class($tbl_style_count); ?>" style="max-width:700px">
				<thead>
						<?php
							...
							echo '<tr><th colspan="'.$category_count.'" class="td-special">SHIFT B</th></tr>';
							echo '<tr> <th class="td-special">CATEGORY</th>';
