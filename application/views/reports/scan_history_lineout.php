...
<head>
	...
	<title>PMCS | Scan History - Line Out</title>
...
<div>
	<h4 style="margin-bottom:20px;text-align:center;font-weight:bold">SCAN HISTORY - LINE OUT</h4>
	...
	<div class="col-md-12" style="margin-bottom:20px">
		...
		<div class="col-md-3">
			...
			<input type="text" class="form-control input-sm " value="LINE OUT" disabled>
		</div>
		<div class="col-md-2">
			<label>Line No</label>
...
<script src="<?php echo base_url(); ?>assets/views/report/scan_history_lineout.js?v1.1"></script>
