...
<html>
  <head>
    ...
    <title>PMCS | Sending Failed Emails</title>
            ...
            <div class="panel-body">
                ...
                <div id="hbreadcrumb" class="pull-right m-t-lg">
                    <ol class="hbreadcrumb breadcrumb">
                        ...
                        <li class="active">
                            <span>Sending Failed Emails</span>
                        </li>
                    </ol>
                </div>
                <h2 class="font-light m-b-xs text-success">
                    Sending Failed Emails
                </h2>
            </div>
        </div>
        </div>
 ...
 <!-- jQuery 2.1.4 -->
    ...
    <!-- page js file -->
    <script src="<?php echo base_url(); ?>assets/views/task/sending_fail_emails.js"></script>
