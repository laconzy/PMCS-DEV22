(function () {
	...
	$(document).ready(function () {
		...
		$('#btn_create_bundles').click(function () {
			...
			appAlertConfirm('Do you want to create the bundle chart for this laysheet?', function () {
				...
				appAjaxRequest({
					...
					url: BASE_URL + 'index.php/cutting/bundle_4/save',
		...
		$('#bundle_chart_table tbody').on('click', 'button', function () {
			...
			appAlertConfirm('Do you want to delete selected bundle?', function () {
				setTimeout(function(){
					appAjaxRequest({
						url: BASE_URL + 'index.php/cutting/bundle_4/destroy/' + LAYSHEET_NO + '/' + bundle_no,
						type: 'post',
						dataType: 'json',
						async : false,
						success: function (res) {
		...
		$('#btn_delete_all').click(function () {
			...
			appAlertConfirm('Do you want to delete all bundles?', function () {
				setTimeout(function(){
					appAjaxRequest({
						url: BASE_URL + 'index.php/cutting/bundle_4/destroy_all/' + LAYSHEET_NO,
						type: 'post',
						dataType: 'json',
						async : false,
						success: function (res) {
		...
		$('#btn_print_barcode').click(function () {
			...
			if (LAYSHEET != null) {
				...
				window.open(BASE_URL + 'index.php/cutting/bundle/print_barcode/' + LAYSHEET.laysheet_no + '/' + a);
	...
	function reload_summery_table(laysheet_no) {
		...
		appAjaxRequest({
			...
			url: BASE_URL + 'index.php/cutting/bundle_4/get_laysheet_details/' + laysheet_no,
	...
	function load_bundle_chart(laysheet) {
		...
		appAjaxRequest({
			...
			url: BASE_URL + 'index.php/cutting/bundle_4/get_bundle_chart/' + laysheet,
