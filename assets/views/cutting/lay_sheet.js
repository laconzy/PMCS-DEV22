...
$("#component tbody tr").remove();
                    ...
                    for (var i = 0; i < detail.length; i++) {
                        ...
                        var cut_count =parseInt(detail[i]['cut_count']);
                            var status="";
                            var button="";
...
button='<button class="btn  btn-success btn-flat btn-sm" data-id="' + detail[i]['line_no'] + '" onclick="print_laysheet('+ord_id+','+ detail[i]['line_no'] +','+detail[i]['item_id'] +','+detail[i]['ord_id'] +','+detail[i]['plies'] +')" >Print</button>';
