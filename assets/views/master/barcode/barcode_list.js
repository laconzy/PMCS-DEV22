...
$(document).ready(function() {
    ...
    TABLE = $('#sites-table').DataTable( {
      ...
      "autowidth":false,
		  ...
		  "serverSide": true,
        "ajax": {
            "url": BASE_URL+"index.php/master/barcode/get_barcodes",
            "type": "POST",
            "data" : {
...
function open_barcode(ele)
{
    //alert($(ele).attr('data-id'));
    window.open(BASE_URL+'index.php/master/barcode/barcode_view/'+$(ele).attr('data-id'));
}
