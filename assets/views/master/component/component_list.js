...
$(document).ready(function() {
    ...
    TABLE = $('#component-table').DataTable( {
      ...
      "autowidth":false,
		  ...
		  "serverSide": true,
        "ajax": {
            "url": BASE_URL+"index.php/master/component/get_component",
            "type": "POST",
            "data" : {
...
$('#component-table').on('click','button',function(){
	var ele = $(this);
	var type = ele.attr('data-btn');
	if( type === 'view')
		open_component(this);
	else if(type === 'delete' )
		delete_component(this);
});

function open_component(ele)
{
    //alert($(ele).attr('data-id'));
    window.open(BASE_URL+'index.php/master/component/component_view/'+$(ele).attr('data-id'));
}


function delete_component(ele)
{
  var com_id = $(ele).attr('data-id');
  appAlertConfirm('Do you want to deactivate selected component?' , function(){
    appAjaxRequest({
      url : BASE_URL + 'index.php/master/component/destroy/'+com_id,
      type: 'post',
      dataType : 'json',
