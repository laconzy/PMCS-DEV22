...
$(document).ready(function() {
    ...
    TABLE = $('#size-table').DataTable( {
      ...
      "autowidth":false,
		  ...
		  "serverSide": true,
        "ajax": {
            "url": BASE_URL+"index.php/master/size/get_sizes",
            "type": "POST",
            "data" : {
...
$('#size-table').on('click','button',function(){
	var ele = $(this);
...
function open_size(ele)
{
    //alert($(ele).attr('data-id'));
    window.open(BASE_URL+'index.php/master/size/size_view/'+$(ele).attr('data-id'));
}


function delete_size(ele)
{
  var size_id = $(ele).attr('data-id');
  appAlertConfirm('Do you want to deactivate selected size?' , function(){
    appAjaxRequest({
      url : BASE_URL + 'index.php/master/size/destroy/'+size_id,
      type: 'post',
      dataType : 'json',
